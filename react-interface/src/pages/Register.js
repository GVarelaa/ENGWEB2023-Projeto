...
function Register() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(
        env.authAccessPoint + "/register" + `?token=${localStorage.token}`,
        {
          name: nome,
          surname: apelido,
          email: email,
            ...
            <Card className="shadow-lg">
              <Card.Body>
                <div className="mb-3 mt-md-4">
                  ...
                  <p className=" mb-4">
                    Insira os seus dados para efetuar o registo.
                  </p>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    {usernameExists ? (
                      ...
                      >
                        ...
                        <Form.Control.Feedback type="invalid">
                          {" "}
                          O username já está a ser utilizado!{" "}
                        </Form.Control.Feedback>
                      </FloatingLabel>
                    ) : (
                      <FloatingLabel
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item onClick={() => setNivel("Consumidor")}>
                            Consumidor
                          </Dropdown.Item>
                          <Dropdown.Item onClick={() => setNivel("Produtor")}>
                            Produtor
                          </Dropdown.Item>
                        </Dropdown.Menu>
                      </Dropdown>
  ...
  return <>{isSubmitted ? <Navigate to="/" /> : registerForm}</>;
}
