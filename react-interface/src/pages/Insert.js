...
function Insert() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            axios.get(env.apiTribunaisAccessPoint)
                .then(response => {
                    setTribunais(response.data)
                    axios.get(env.apiTribunaisAccessPoint + '/' + response.data[0]._id + '/descritores')
                        .then(response => {
                            setListaDescritores(response.data.descritores)
                        })
                        .catch(error => {
...
const handleTribunal = (e) => {
    ...
    axios.get(env.apiTribunaisAccessPoint + '/' + tribunal + '/descritores')
        .then(response => {
            setListaDescritores(response.data.descritores)
        })
        .catch(error => {
...
const handleSubmit = (event) => {
    ...
    axios.post(env.apiAcordaosAccessPoint, {
        Processo: processo,
        Relator: relator,
